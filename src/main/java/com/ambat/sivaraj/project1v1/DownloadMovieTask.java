...
public class DownloadMovieTask extends AsyncTask<String, Void, List<Movie>> {

    public AsyncResponse delegate;
    private final String API_KEY = "f7dac4d9d38e598ce6ed1ffdbd4fe7f5";
    private final String MOVIE_POSTER_BASE = "http://image.tmdb.org/t/p/";
    private final String MOVIE_POSTER_SIZE = "w185";

    public DownloadMovieTask(AsyncResponse delegate){
